...
# -*- coding: utf-8 -*-
#
# releng-sop documentation build configuration file, created by
# sphinx-quickstart on Thu Aug  4 09:45:22 2016.
#
...
htmlhelp_basename = 'releng-sopdoc'
...
latex_documents = [
    (master_doc, 'releng-sop.tex', 'releng-sop Documentation',
     'Daniel Mach', 'manual'),
]
...
man_pages = [
    (master_doc, 'releng-sop', 'releng-sop Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'releng-sop', 'releng-sop Documentation',
     author, 'releng-sop', 'One line description of project.',
     'Miscellaneous'),
]
